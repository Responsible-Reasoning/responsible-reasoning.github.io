...
group :jekyll_plugins do
    ...
    gem 'jekyll-scholar' # required: al_folio_core layouts register the {% bibliography %} tag
    gem 'jekyll-sitemap'
    gem 'jekyll-socials'
    gem 'jekyll-tabs'
    # jekyll-terser (git-sourced) omitted: production-only JS minification, not required to render the site locally
    gem 'jekyll-toc'
